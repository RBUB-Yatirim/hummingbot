...
WS_BASE_URL = "wss://ws-feed-pro.btcturk.com/"
...
class BtcTurkAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, btcturk_auth: BtcturkAuth, trading_pairs: Optional[List[str]] = None):
        super().__init__()
        self.btcturk_auth: BtcturkAuth = btcturk_auth
    ...
    def get_ws_connection(self):
        ws = websockets.connect(WS_BASE_URL, extra_headers=self.btcturk_auth.generate_auth_dict())
        return ws
